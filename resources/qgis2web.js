...
map.getView().fit([12547944.831923, -812448.392705, 12553874.899449, -808244.052366], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Persebaran Halte</h2>';
        return titleElement;
    })(),
